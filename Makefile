build:
	docker build --platform=linux/amd64 --tag space-football.cr.cloud.ru/sfootball_landing:v.0.1 .
local_build:
	docker build  -t sfootball_tgapp_local .
push:
	docker push space-football.cr.cloud.ru/sfootball_landing:v.0.1
# tag:
